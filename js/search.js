...
function popularCamping(){
	...
	request.open("GET", SMAPI + "&controller=establishment&method=getall&descriptions=camping&sort_in=desc&order_by=rating&per_page=5&debug=true&format=json&nojsoncallback=1",true);
